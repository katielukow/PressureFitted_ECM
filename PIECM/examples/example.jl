...
#     Plot({color = Ϟ[5], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x40[:,"SOC"].*100, y = x40[:,"R0"])),
#     LegendEntry("40 kPa"),
#     Plot({color = Ϟ[6], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x25[:,"SOC"].*100, y = x25[:,"R0"])),
#     LegendEntry("130 kPa"),
#     Plot({color = Ϟ[7], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x130[:,"SOC"].*100, y = x130[:,"R0"])),
#     LegendEntry("200 kPa"),
#     {
#         # xlabel="State-of-Charge ["*L"\%"*"]",
#         ylabel="Parameter R1",
...
#     Plot({color = Ϟ[5], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x40[:,"SOC"].*100, y = x40[:,"R1"])),
#     Plot({color = Ϟ[6], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x25[:,"SOC"].*100, y = x25[:,"R1"])),
#     Plot({color = Ϟ[7], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x130[:,"SOC"].*100, y = x130[:,"R1"])),
...
#     Plot({color = Ϟ[5], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x40[:,"SOC"].*100, y = x40[:,"C1"])),
#     Plot({color = Ϟ[6], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x25[:,"SOC"].*100, y = x25[:,"C1"])),
#     Plot({color = Ϟ[7], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x130[:,"SOC"].*100, y = x130[:,"C1"])),
...
#     Plot({color = Ϟ[8], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x0[:,"SOC"].*100, y = x0[:,"R0"])),
#     LegendEntry("0 kPa"),
#     Plot({color = Ϟ[10], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x50[:,"SOC"].*100, y = x50[:,"R0"])),
#     LegendEntry("50 kPa"),
#     Plot({color = Ϟ[14], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x100[:,"SOC"].*100, y = x100[:,"R0"])),
#     LegendEntry("100 kPa"),
#     {
#         xlabel="State-of-Charge ["*L"\%"*"]",
#         ylabel="Parameter R1",
...
#     Plot({color = Ϟ[8], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x0[:,"SOC"].*100, y = x0[:,"R1"])),
#     Plot({color = Ϟ[10], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x50[:,"SOC"].*100, y = x50[:,"R1"])),
#     Plot({color = Ϟ[14], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x100[:,"SOC"].*100, y = x100[:,"R1"])),
...
#     Plot({color = Ϟ[8], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x0[:,"SOC"].*100, y = x0[:,"C1"])),
#     Plot({color = Ϟ[10], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x50[:,"SOC"].*100, y = x50[:,"C1"])),
#     Plot({color = Ϟ[14], "thick", style ={"dashed"}}, Table({x = "x", y = "y"}, x = x100[:,"SOC"].*100, y = x100[:,"C1"])),
# )
